...
void handleRoot() {
  ...
  "<p><a href=\"ir?code=45\">Set fan mode Auto2</a></p>" \
  "<p><a href=\"ir?code=44\">Set fan mode Turbo</a></p>" \
...
void handleIr() {
  ...
  ac.on();
  ac.setSwing(kSamsungAcSwingMove);
...
if(code == 45) //FAN_Auto
  ...
  Serial.begin(115200);
  delay(200);
  ac.setSwing(kSamsungAcSwingMask);
    ac.send();}
  ...
  Serial.begin(115200);
  delay(200);
  ac.setSwing(kSamsungAcSwingStop);
    ac.send();}
...
>>>>>>> 6b7f9bfda0d3739249f3bc0851d611b010f0939b
